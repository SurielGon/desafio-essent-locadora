        ...
        <div className='flex flex-col'>
          <div className='flex flex-row gap-x-6 justify-between'>
            <div className='flex flex-col'>
              ...
              <input
                placeholder='Aventuras Incríveis'
            ...
            <div className='flex flex-col'>
              ...
              <input
                ...
                type='number'
                className='p-1 rounded outline outline-1 outline-offset-1 focus:outline-none focus:ring focus:border-blue-500'
                {...register('quantidadeDisponivel', { required: true })}
              />
              <ErrorComponent
                msg='Quantidade é obrigatória'
                show={!!errors.quantidadeDisponivel}
              />
            </div>
          </div>
          <div className='flex flex-row gap-x-6 justify-between'>
          ...
          <div className='flex flex-row gap-x-6 justify-between max-w-md'>
            <div className='flex flex-col max-w-xs'>
              ...
              />
              <ErrorComponent
                msg='Data de lançamento é obrigatória'
                show={!!errors.dataLancamento}
              />
            </div>
            <div className='flex flex-col'>
          ...
          <input
            placeholder='Leonardo DiCaprio, Morgan Freeman'
            type='text'
            className='p-1 rounded outline outline-1 outline-offset-1 focus:outline-none focus:ring focus:border-blue-500'
